...
def side_by_side_video(videos_dir, n_DAs, fade_out_frame, name, fade_duration=2,
                            verbose=False):
    """Creates bash file to merge the DA videos and add fade in fade out effects using ffmpeg"""
